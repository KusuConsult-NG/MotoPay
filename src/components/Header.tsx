        ...
        <header className="sticky top-0 z-50 w-full border-b border-solid border-[#e7e9f3] bg-white/80 backdrop-blur-md">
            <div className="max-w-[1280px] mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    <Link className="text-[#0d101b] text-sm font-medium hover:text-primary transition-colors" to="/services">Services</Link>
                    <Link className="text-[#0d101b] text-sm font-medium hover:text-primary transition-colors" to="/about">About</Link>
                    <Link className="text-[#0d101b] text-sm font-medium hover:text-primary transition-colors" to="/contact">Contact</Link>
                    <Link className="text-[#0d101b] text-sm font-medium hover:text-primary transition-colors" to="/help">Help</Link>
                </nav>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link to="/register" className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-10 px-4 bg-[#e7e9f3] text-[#0d101b] text-sm font-bold transition-all hover:bg-[#d1d5db]">
                        Sign Up
                    </Link>
                    <div
